<template>
  ...
  <div class="main-Content">
    <div class="rightDV">
      <div class="towColDataContent">
        <div class="rightColDv">
          <div class="dataDV">
            <div class="itemsDv">
          ...
          <div class="databan">
           <div class="lasrChild">
              <h1>American Footbal</h1>
            </div>
           <div class="lasrChild">
              <h1>Australian Rules</h1>
            </div>
           <div class="lasrChild">
              <h1>Baseball</h1>
            </div>
        ...
        <div class="centerColDv">
          ...
          <div class="tableDv">
            <div class="haderDv">
           <h3>Price Movement History</h3>
            </div>
            <div class="bodyDV">
              <div class="boderRowTable">
                <div class="item">
                  <h3> Time</h3>
                </div>
    ...
    <div class="leftDv">
      <div class="dataDV">
        ...
        <div class="itemsDv">
          <div class="headerItem"><h3>AI Predictions</h3></div>
          <div class="databan">
            <div class="firetDV">
              <p>Lakers $ 2.10</p>
            </div>
            <div class="tabDv">
              <div class="item fir">Lakers</div>
              <div class="bor"></div>
              <div class="item">$ 2.10</div>
            </div>
            <div class="tabDv">
              <div class="item fir">Total</div>
              <div class="bor"></div>
              <div class="item">$ 2.10</div>
            </div>
          </div>
        ...
        <div class="itemsDv">
          ...
          <div class="databan">
            ...
            <div class="tabDv">
              <div class="item fir"> LaPers</div>
              <div class="bor"></div>
              <div class="item">$1.90</div>
            </div>
            <div class="tabDv">
              <div class="item fir">First Half</div>
              <div class="bor"></div>
              <div class="item">$1.85</div>
            </div>
            <div class="tabDv">
              <div class="item fir">Quarter 3</div>
              <div class="bor"></div>
        ...
        <div class="itemsDv">
          <div class="headerItem">
            <h3>AI Predictions & Weather Forecast:</h3>
          </div>
          <div class="databan">
            <div class="lasrChild">
